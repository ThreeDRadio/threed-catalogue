...
<HTML>
<head>
<TITLE>ThreeD - Edit File Categories</TITLE>
...
$query = "SELECT * FROM filecat WHERE id = $q$gid$q;";
$result = pg_query($db, $query);
$num = pg_num_rows($result);
if ($num != 1) {
	echo "<p><font color=red><b>Category does not exist!</b></font><p>";
	echo "</BODY></HTML>";
	exit;
}
...
<b>EDIT FILE CATEGORIES</b>

<p>
<form action=filecatedit.php method=post>
